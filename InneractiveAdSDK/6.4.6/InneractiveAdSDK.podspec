Pod::Spec.new do |spec|
	...
	spec.version = '6.4.6'
	spec.license = { :type => 'Copyright', :text => 'Copyright 2017 Inneractive, All rights reserved.' }
	...
	spec.source = { :git => 'https://github.com/inner-active/InneractiveAdSDK-iOS.git', :branch => '6.4.6', :tag => spec.version }
