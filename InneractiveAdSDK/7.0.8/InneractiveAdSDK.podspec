Pod::Spec.new do |spec|
	...
	spec.source = { :git => 'https://github.com/inner-active/InneractiveAdSDK-iOS.git', :branch => '7.0.8', :tag => spec.version }
    ...
    spec.subspec 'IASDKCore' do |core|
        ...
        core.source = { :git => 'https://github.com/inner-active/InneractiveAdSDK-iOS.git', :branch => '7.0.8', :tag => spec.version }
    ...
    spec.subspec 'IASDKMRAID' do |display|
        ...
        display.source = { :git => 'https://github.com/inner-active/InneractiveAdSDK-iOS.git', :branch => '7.0.8', :tag => spec.version }
    ...
    spec.subspec 'IASDKVideo' do |video|
        ...
        video.source = { :git => 'https://github.com/inner-active/InneractiveAdSDK-iOS.git', :branch => '7.0.8', :tag => spec.version }
    ...
    spec.subspec 'IASDKNative' do |native|
        ...
        native.source = { :git => 'https://github.com/inner-active/InneractiveAdSDK-iOS.git', :branch => '7.0.8', :tag => spec.version }
